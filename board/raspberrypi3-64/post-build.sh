...
elif grep -q "^BR2_PACKAGE_RPI_FIRMWARE_VARIANT_PI=y" "$BR2_CONFIG"; then
    # VARIANT_PI is the firmware set for Zero/1/2/3; on this tree only the
    # Pi 3 64-bit board selects it. Anchored so VARIANT_PI4 can't match here.
